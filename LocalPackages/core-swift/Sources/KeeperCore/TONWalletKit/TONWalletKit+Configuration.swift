    ...
    convenience init(
        ...
        let configuration = TONWalletKitConfiguration(
            ...
            walletManifest: TONWalletKitConfiguration.Manifest(
                ...
                name: "tos",
                appName: "TOS Wallet",
                imageUrl: "https://tos.network/assets/tos-logo.png",
                aboutUrl: "https://tos.network",
                universalLink: "https://app.tos.network/ton-connect",
                bridgeUrl: bridgeURL
            ),
            storage: .keychain,
            sessionManager: sessionManager,
            bridge: TONWalletKitConfiguration.Bridge(bridgeUrl: bridgeURL, webViewInjectionKey: "tos"),
