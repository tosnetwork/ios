...
public final class APIAssembly {
    ...
    var tonAPIURL: URL {
        URL(string: "https://rpc.tos.network")!
    }
    ...
    var testnetTonAPIURL: URL {
        URL(string: "https://testnet-rpc.tos.network")!
    }

    var tonConnectURL: URL {
        URL(string: "https://bridge.tos.network")!
    }

    private var swapAPIURL: URL {
        URL(string: "https://swap.tos.network")!
    }

    var tonConnectBridgeURL: URL {
        URL(string: "https://bridge.tos.network/bridge")!
    }
}
